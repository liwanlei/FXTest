...
app.add_url_rule('/ceshihuanjing',view_func=TesteventVies.as_view('ceshihuanjing'))
...
app.add_url_rule('/mock',view_func=MockViews.as_view('mockserver'))
app.add_url_rule('/addmock',view_func=AddmockViews.as_view('addmock'))
app.add_url_rule('/deletemock/<int:id>',view_func=DeletemockViews.as_view('deletemock'))
app.add_url_rule('/editmockserver/<int:id>',view_func=EditmockserView.as_view('editmockserver'))
app.add_url_rule('/mackserver/<string:path>',view_func=MakemockserverView.as_view('mackserver'))
