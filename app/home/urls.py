...
home.add_url_rule('/testenvironment', view_func=TesteventVies.as_view('testenvironment'))
home.add_url_rule('/testenvironment/<int:page>', view_func=TesteventVies.as_view('testenvironmenta'))
